   ...
   <div class="clearfix grpelem" id="ppu1713"><!-- column -->
    <div  class="clearfix colelem" id="pu1713"><!-- group -->
     ...
     <div class="clearfix grpelem" id="u1666-4" data-muse-temp-textContainer-sizePolicy="true" data-muse-temp-textContainer-pinning="true"><!-- content -->
      <p id="u1666-2" style="position: fixed; padding-left:20px" >SERVIÇO DE SAÚDE DA CIDADE DE MAPUTO</p>
     </div>
    </div>
    <div class="clearfix colelem" id="u4181-4" data-muse-temp-textContainer-sizePolicy="true" data-muse-temp-textContainer-pinning="true"><!-- content -->
	 ...
	 <?php
		$link=$_GET["link"];
		$pag[1]			="registoUnidade.php";
		$pag[2]			="verUnidade_individual.php";
		$pag[3]			="busca.php";
...
Muse.Utils.transformMarkupToFixBrowserProblems();/* body */
  ...
  <!--HTML Widget code-->
        ...
        $(window).load(function() { // makes sure the whole site is loaded
            $('.status').delay(1*150).fadeOut(1*10); // will first fade out the loading animation
            $('.preloader').delay((1*100)+100).fadeOut(1*10); // will fade out the white DIV that covers the website.
