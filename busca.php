 ...
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   <div class="clearfix colelem" id="pu742"><!-- column -->
	...
	if(@$data_inicial!=""){
		$sql =  "select * from `$tablela` where `ID_USUARIO`<>'2' and type='2' order by `SECTOR` asc limit 0,10";
	}
	else{
		$sql =  "select * from `$tablela` where `ID_USUARIO`<>'2' and type='2' order by `SECTOR` asc limit 0,50";
	}
    ...
    <div class="clearfix colelem" id="u732"><!-- group -->
     <div class="clearfix grpelem" id="u737"><!-- group -->
      ...
      <div class="clearfix grpelem" id="u736-4" data-muse-temp-textContainer-sizePolicy="true" data-muse-temp-textContainer-pinning="true"><!-- content -->
       <p id="u736-2"><a style="text-decoration:none" href="https://www.google.com/maps?hl=en&q=<?=$registo["lat"]?>,<?=$registo["lng"]?>" target="blank"><img src="images/location.png" alt="Avatar" style="width:3%"><?php echo $registo["MORADA"];?></a></p>
      </div>
      ...
      <a href="index.php?link=6&id=<?php echo $registo["ID_USUARIO"];?>&op=ver"><div class="grpelem" id="u740"><!-- simple frame --></div></a>
